...
//                    + " ('Avengers: Age of Ultron', 2015, 10.00, 'Action, Adventure, Sci-Fi', 'age_of_ultron')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Avatar', 2009, 10.00, 'Action, Adventure, Fantasy, Sci-Fi', 'avatar')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('The Lord of the Rings: The Two Towers', 2002, 8.50, 'Adventure, Drama, Fantasy', '2towers')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('The Avengers', 2012, 10.00, 'Action, Adventure, Sci-Fi', 'avengers')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Captain America: Civil War', 2016, 10.00, 'Action, Adventure, Sci-Fi', 'civil_war')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Despicable Me 2', 2013, 10.00, 'Animation, Adventure, Comedy, Family, Fantasy, Sci-Fi', 'des_me_2')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Despicable Me 3', 2017, 10.00, 'Animation, Adventure, Comedy, Family, Fantasy, Sci-Fi', 'des_me_3')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Finding Dory', 2016, 8.50, 'Animation, Adventure, Comedy, Family', 'dory')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Avengers: Endgame', 2019, 10.00, 'Action, Adventure, Fantasy, Sci-Fi', 'endgame')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('The Fate of the Furious', 2017, 8.50, 'Action, Crime, Thriller', 'fate_of_furious')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Star Wars: Episode VII - The Force Awaken', 2015, 10.00, 'Action, Adventure, Fantasy, Sci-Fi', 'force_awakens')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Jurassic World: Fallen Kingdom', 2016, 10.00, 'Action, Adventure, Sci-Fi', 'jurassicworld_fk')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Pirates of the Caribbean: On Stranger Tides', 2011, 10.00, 'Action, Adventure, Fantasy', 'pirates_stranger_tides')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
//                    + " ('Toy Story 4', 2019, 10.00, 'Animation, Adventure, Comedy, Family, Fantasy', 'toystory4')");
//            insert.executeUpdate();
//            insert = con.prepareStatement("INSERT INTO movies (name, year, price, genre, poster) VALUES"
...
//    }
    ...
    public Customer logIn(String search) throws Exception {
        ...
        PreparedStatement customerCheck = con.prepareStatement("SELECT customerid, firstname, lastname, dob, phonenum from customers "
